# DSA — Past Papers & Practice (Organized by Topic)

> **BITS Pilani — SE ZG519 / DSECLZG519**
> All past year + practice questions grouped by topic for easy preparation
> Source: 2024 Mid-Sem, March 2026 Mid-Sem, May 2026 Comprehensive + Practice
>
...
- [Topic 1: Algorithm Basics & Step Counting](#topic-1-algorithm-basics--step-counting)
- [Topic 2: Asymptotic Notation & Master Theorem](#topic-2-asymptotic-notation--master-theorem)
- [Topic 3: Recurrence Relations — Recursion Tree & Substitution](#topic-3-recurrence-relations--recursion-tree--substitution)
- [Topic 4: Stack Operations & Applications](#topic-4-stack-operations--applications)
- [Topic 5: Queue Operations](#topic-5-queue-operations)
- [Topic 6: Linked List Operations](#topic-6-linked-list-operations)
- [Topic 7: Amortized Analysis](#topic-7-amortized-analysis)
- [Topic 8: Binary Trees & BST](#topic-8-binary-trees--bst)
- [Topic 9: Heaps & Heap Sort](#topic-9-heaps--heap-sort)
- [Topic 10: Graphs — BFS & DFS](#topic-10-graphs--bfs--dfs)
- [Topic 11: Hashing](#topic-11-hashing)
- [Topic 12: Advanced Topics (Comprehensive Exam)](#topic-12-advanced-topics-comprehensive-exam)
- [Quick Revision — Key Formulas & Facts](#quick-revision--key-formulas--facts)

---

**Source Key:**
- **[Past Year 2024]** — Studocu mid-sem (2024 EC2 Makeup)
- **[Past Year 2026 Mid]** — GitHub March 2026 (EC2 Regular)
- **[Past Year 2026 Comp]** — GitHub May 2026 Comprehensive
- **[Practice]** — Practice questions

---
---

# TOPIC 1: Algorithm Basics & Step Counting

> **What to know:** Counting primitive operations in code snippets, analyzing nested loops, loops with halving/doubling, and determining best/worst/average case time complexity from code structure.

---

## 1.1 Step Counting — Loop Analysis [Practice]
...
## 1.2 Step Counting — Nested Halving Loop [Practice]
...
# TOPIC 2: Asymptotic Notation & Master Theorem

> **What to know:** Master Theorem in its extended form (with log^p factor), identifying a, b, f(n), computing n^(log_b a), determining which case applies, and stating the final answer. Know the three cases plus the extended Case 2 sub-cases for p.
...
### 2.1 T(n) = 8T(n/2) + √n · log⁻²n [Past Year 2024]

**Question:** Solve T(n) = 8T(n/2) + √n · log⁻²n using the Master Theorem.

**Answer:**

Identify the parameters: T(n) = aT(n/b) + Θ(n^k · log^p n)
...
### 2.3 T(n) = 9T(n/3) + n [Past Year 2026 Comp]

**Question:** Solve T(n) = 9T(n/3) + n using the Master Theorem.
...
### 2.4 T(n) = 4T(n/2) + n²log n [Past Year 2026 Comp]

**Question:** Solve T(n) = 4T(n/2) + n²log n using the Master Theorem.
...
### 2.5 T(n) = 2T(n/2) + n·log n [Past Year 2026 Comp]

**Question:** Solve T(n) = 2T(n/2) + n·log n using the Master Theorem.
...
### 2.6 T(n) = 3T(n/3) + n/log n [Past Year 2026 Comp]

**Question:** Solve T(n) = 3T(n/3) + n/log n using the Master Theorem.
...
### 2.8 T(n) = 4T(n/2) + n² · log³ n [Practice]
...
### 2.9 T(n) = 2T(n/2) + n/log n [Practice]
...
### 2.10 T(n) = 2T(n/4) + n^(0.51) [Past Year 2026 Comp]

**Question:** Solve T(n) = 2T(n/4) + n^(0.51) using the Master Theorem.
...
# TOPIC 3: Recurrence Relations — Recursion Tree & Substitution

> **What to know:** Recursion tree method — draw the tree, compute cost at each level, sum the geometric series. Substitution method — guess the bound, prove by induction. Change of variables technique for unusual recurrences.

---

## 3.1 Recursion Tree — T(n) = 3T(n/4) + cn² [Practice]
...
## 3.2 Substitution Method — T(n) = 2T(⌊n/2⌋) + n [Practice]
...
# TOPIC 4: Stack Operations & Applications

> **What to know:** Stack traces (push/pop sequences), browser back button as stack, infix-to-postfix conversion with stack traces, postfix evaluation with stack traces, prefix evaluation, balanced parentheses.

---

## 4.1 Browser Back Button Data Structure [Past Year 2024]
...
## 4.2 Stack Operations Trace [Practice]
...
## 4.3 Postfix Expression Evaluation — ABC+CBA-+ [Past Year 2024]
...
The expression `ABC+CBA-+` has 5 operands and 3 operators → leaves 2 values on stack: `[1, 5, 4]`.
...
## 4.4 Postfix Evaluation — Complex Expression [Practice]
...
## 4.5 Postfix Evaluation — Simple Expression [Practice]
...
## 4.6 Infix to Postfix — Fill Blanks in Algorithm [Past Year 2026 Mid]
...
## 4.7 Infix to Postfix — a+((b-c)-d) [Past Year 2026 Mid]
...
## 4.8 Infix to Postfix — (A+B)*(C-D/(E+F)) [Practice]
...
## 4.9 Infix to Postfix — A*B+C/D-E [Practice]
...
> **What to know:** Circular queue mechanics (front/rear pointers, wrap-around using modulo), enqueue/dequeue traces, overflow/underflow detection, and implementing a queue using two stacks with amortized analysis.

---

## 5.1 Circular Queue Trace — Size 5 [Past Year 2024]
...
## 5.2 Circular Queue Trace — Size 4 with Overflow [Practice]
...
| Enqueue(E) | `[E, _, C, D]` | 2 | 0 | 3 | Wraps! rear=(3+1)%4=0 |
...
## 5.3 Queue Using Two Stacks [Past Year 2024]
...
# TOPIC 6: Linked List Operations

> **What to know:** Doubly linked list delete (finding and fixing bugs), singly linked list delete by value, singly linked list reverse (iterative with pointer traces), and linked list operation complexities.

---

## 6.1 Doubly Linked List Delete — Find the Bug [Past Year 2024]
...
## 6.2 Singly Linked List — Delete a Node [Practice]
...
## 6.3 Singly Linked List — Reverse [Practice]
...
# TOPIC 7: Amortized Analysis

> **What to know:** Aggregate method, accounting method, and potential method. Key problems: dynamic array (doubling), MULTIPOP stack, and two-stack queue. The key insight is that expensive operations happen rarely enough that the average cost per operation stays constant.

---

## 7.1 Dynamic Array — Aggregate Method [Past Year 2024]
...
## 7.2 MULTIPOP Stack — Aggregate Method [Practice]
...
# TOPIC 8: Binary Trees & BST

> **What to know:** Array representation of binary trees (index formulas: left=2i, right=2i+1), constructing trees from inorder+postorder or inorder+preorder traversals, BST search (recursive trace), BST insert/delete traces, printing BST in descending order (reverse inorder), tree properties (height, nodes, leaves).

---

## 8.1 BST — Print in Descending Order [Past Year 2024]
...
## 8.2 Construct Binary Tree from Inorder + Postorder [Past Year 2024]
...
## 8.3 Array Representation of Binary Tree — Q4b [Past Year 2024]

**Question:** What is the minimum array size needed to store the tree from Q8.2? Show the array representation.
...
## 8.4 Array Representation of Binary Tree — Letters [Past Year 2026 Mid]
...
## 8.5 Fill Blanks — Recursive Binary Tree Search [Past Year 2026 Mid]
...
## 8.6 Trace Search for key = 'G' [Past Year 2026 Mid]

**Question:** Using the tree from 8.4 and the algorithm from 8.5, trace the search for key = G.
...
## 8.7 Construct Tree from Inorder + Preorder [Practice]
...
## 8.8 Construct Tree from Inorder + Postorder — Problem 2 [Practice]
...
## 8.9 BST Insertion Trace [Practice]
...
## 8.10 BST Deletion Trace [Practice]
...
# TOPIC 9: Heaps & Heap Sort

> **What to know:** Max-heap and min-heap properties, insertion with bubble-up, extract-max/min with heapify-down, BUILD-HEAP from array (bottom-up, O(n) time), and HeapSort (build max-heap + repeated extract-max). Array representation: parent=⌊i/2⌋, left=2i, right=2i+1.

---

## 9.1 Max-Heap — Insertion Trace [Practice]
...
## 9.2 Max-Heap — Extract-Max Trace [Practice]
...
2. Heapify down:
   ...
   - Array: [25, 20, 5, 10, 15]
   - Now at index 2: children at indices 5,6 → no children (only 5 elements, indices 0-4)
   - Stop.
...
## 9.3 Min-Heap — Build Heap from Array [Practice]
...
## 9.4 HeapSort Complete Trace [Practice]
...
# TOPIC 10: Graphs — BFS & DFS

> **What to know:** BFS algorithm (plain English + pseudocode), BFS trace with queue states and visited arrays, DFS trace with stack/recursion and discovery/finish times, BFS from adjacency matrix, topological sort using Kahn's algorithm (BFS-based) and DFS-based, edge classification (tree, back, forward, cross edges).

---

## 10.1 BFS from Adjacency Matrix [Past Year 2024]
...
## 10.2 BFS Algorithm in Plain English [Past Year 2026 Mid]
...
## 10.3 BFS Trace — Graph with Letters [Past Year 2026 Mid]
...
## 10.4 Topological Sort — Course Prerequisites [Past Year 2024]
...
## 10.5 BFS Trace — Directed Graph [Practice]
...
## 10.6 DFS Trace — Directed Graph [Practice]

**Question:** Perform DFS on the same directed graph from 10.5, starting from vertex 0. Show the discovery times and finish times.
...
## 10.7 Topological Sort — Task Dependencies [Practice]
...
**Other valid orderings** (multiple because of choices at steps where multiple vertices have in-degree 0):
- A, B, C, D, E, F
- A, B, C, E, D, F
- A, B, D, C, E, F
- A, B, D, E, C, F
...
## 10.8 BFS vs DFS Comparison [Practice]
...
> **What to know:** Hash functions (linear form h(k) = (mk + c) mod m), double hashing formula H(k,i) = (h1(k) + i·h2(k)) mod m, insertion traces with collision resolution, requirement that h2(k) ≠ 0.

---

## 11.1 Double Hashing — Full Problem [Past Year 2026 Mid]

### Part (a) — Express h1() and h2() [5 marks]
...
### Part (b) — Double Hashing Formula [5 marks]
...
### Part (c) — Insert Sequence into Hash Table [5 marks]
...
Note: h2 = 0 for keys 42 and 31 is problematic. For this exam problem, we note this anomaly and proceed assuming the probe works for non-zero h2 values. For keys where h2=0, we'd need h1 to find an empty slot directly.
...
| 1 | 4 | No | — | — | **4** |
| 13 | 7 | No | — | — | **7** |
| 11 | 1 | Yes (22) | (1+3) mod 11 = 4 | Yes (1) | Probe 2: (1+6) mod 11 = **7** → Yes. Probe 3: (1+9) mod 11 = **10** → No. Final: **10** |
| 24 | 7 | Yes (13) | (7+6) mod 11 = 2 | No | **2** |
| 33 | 1 | Yes (22) | (1+3)=4 Yes | Probe 2: (1+6)=7 Yes | Probe 3: (1+9)=10 Yes → Probe 4: (1+12) mod 11 = **2** → Yes → Probe 5: (1+15) mod 11 = **5** → No. Final: **5** |
| 18 | 0 | No | — | — | **0** |
| 42 | 6 | No | — | — | **6** |
| 31 | 6 | Yes (42) | h2=0, stuck | — | Would fail without modified h2. In practice, index 3 was empty and would be assigned: **3** |
...
*Note: Key 31 would need a fallback mechanism since h2(31) = 0.*
...
> **What to know:** Minimum Spanning Tree (Kruskal's with Union-Find, Prim's with priority queue), 0-1 Knapsack (DP table construction + backtracking for item selection), Vertex Cover problem and greedy 2-approximation.

---

## 12.1 Minimum Spanning Tree — Kruskal's + Prim's [Past Year 2026 Comp]
...
### Part (b) — Prim's Algorithm (starting from vertex A)
...
## 12.2 Vertex Cover Problem [Past Year 2026 Comp]
...
## 12.3 0-1 Knapsack Problem [Past Year 2026 Comp]
...
- Node at index i: left child = **2i**, right child = **2i + 1**, parent = **⌊i/2⌋**
- Space-efficient only for complete/nearly complete trees
...
- Extract: replace root with last, heapify **down** — O(log n)
- Build heap (bottom-up): O(n)

---

*End of Past Papers & Practice Questions (Organized by Topic)*
